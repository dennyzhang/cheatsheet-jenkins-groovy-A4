...
| Print message to stdout                   | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/print.groovy][print.groovy]]                                                             |
| Get environment variables                 | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/get-env.groovy][get-env.groovy]]                                                           |
| Convert string to list                    | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/split-string.groovy][split-string.groovy]]                                                      |
| Create string with multi-lines            | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/multi-line-string.groovy][multi-line-string.groovy]]                                                 |
| Loop a map                                | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/loop-map.groovy][loop-map.groovy]]                                                          |
| Get hostname by ip                        | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/get-ip-by-hostname.groovy][get-ip-by-hostname.groovy]]                                                |
...
| Name                                 | Command                        |
|--------------------------------------+--------------------------------|
| Pass parameter across jenkins jobs   | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/jenkinsfile-pass-parameter][jenkinsfile-pass-parameter]] |
| Set timeout & retry                  | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/jenkinsfile-timeout-retry][jenkinsfile-timeout-retry]]  |
| Use finally to do cleanup            | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/jenkinsfile-finally][jenkinsfile-finally]]        |
| Run jenkins jobs in a sequential way | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/jenkinsfile-sequentially][jenkinsfile-sequentially]]   |
| Run jenkins jobs in parallel         | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/jenkinsfile-parallelly][jenkinsfile-parallelly]]     |
** Jenkins Groovy
| Name                           | Command                          |
|--------------------------------+----------------------------------|
| Print message to stdout        | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/print.groovy][print.groovy]]                 |
| Get environment variables      | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/get-env.groovy][get-env.groovy]]               |
| Convert string to list         | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/split-string.groovy][split-string.groovy]]          |
| Create string with multi-lines | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/multi-line-string.groovy][multi-line-string.groovy]]     |
| Loop a map                     | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/loop-map.groovy][loop-map.groovy]]              |
| Get hostname by ip             | See [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-jenkins-groovy-A4/get-ip-by-hostname.groovy][get-ip-by-hostname.groovy]]    |
| Convert list to string         | =l.join(";")=, [[http://groovy-lang.org/groovy-dev-kit.html#_list_literals][link: groovy list]] |
** More Resources
