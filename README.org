...
| Name                                 | Command                        |
|--------------------------------------+--------------------------------|
| Pass parameter across jenkins jobs   | See [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/jenkinsfile-pass-parameter][jenkinsfile-pass-parameter]] |
| Set timeout & retry                  | See [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/jenkinsfile-timeout-retry][jenkinsfile-timeout-retry]]  |
| Use finally to do cleanup            | See [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/jenkinsfile-finally][jenkinsfile-finally]]        |
| Run jenkins jobs in a sequential way | See [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/jenkinsfile-sequentially][jenkinsfile-sequentially]]   |
| Run jenkins jobs in parallel         | See [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/jenkinsfile-parallelly][jenkinsfile-parallelly]]     |
** Jenkins Groovy
| Name                           | Command                          |
|--------------------------------+----------------------------------|
