...
| Create a folder/directory if missing     | [[https://github.com/dennyzhang/cheatsheet-jenkins-groovy-A4/blob/master/create-thinbackup-folder.groovy][create-thinbackup-folder.groovy]]                         |
